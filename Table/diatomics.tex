...
$E_{\text{ref}}$ \tnote{a} \cite{Adamowicz_LiH,Davidson_Atoms,Feller_Corrections} & \text{-}8.0705473 & \text{-}15.24826(4) & \text{-}25.28931(2) & \text{-}38.4792(2) & \text{-}75.7382(2) & \text{-}100.4600(3) \\
\multicolumn{1}{c}{} & 
\multicolumn{1}{c}{} &
\multicolumn{1}{c}{} &
...
\end{tabular}
\begin{tablenotes}
\item[a] For LiH, ECG provides the best reference energy\cite{Adamowicz_LiH}. For the rest of the systems, we combined the atomic energies in Ref.~\cite{Davidson_Atoms} with the clamped-ion atomization energies ($D_e$) in this table to produce the reference energies.
