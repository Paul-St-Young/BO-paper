...
\begin{tablenotes}
\item[a] For the atomic references, we use Hylleraas result for Li~\cite{Wang_Li}, and ECG results for Be~\cite{Stanke_Be} and B~\cite{Bubin_B}. Ref.~\cite{Davidson_Atoms} is used for C,N,O and F where the ground-state energies are taken from Table XI.
