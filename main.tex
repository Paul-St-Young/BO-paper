...
We note in passing that the nonadiabatic correction to the atomic ground-state energies of Eq. (\ref{eq:analytical}) is roughly linear in Z, while the relativistic recoil correction scales as $Z^4$.~\cite{Merkt_H2} Therefore, nonadiabatic effects are likely to be less significant than relativistic and other correction for the vast majority of atoms.
...
\multicolumn{1}{c}{} &
\multicolumn{1}{c}{} &
\multicolumn{1}{c}{adiabatic} &
\multicolumn{1}{c}{} &
\multicolumn{1}{c}{} &
\multicolumn{1}{c}{} \\
$D_e$ + ZPE & 0.08929(1) & 0.07597(5) & 0.12959(3) & 0.1271(1) & 0.1614(2) & 0.2141(1) \\
\multicolumn{1}{c}{} & 
\multicolumn{1}{c}{} &
\multicolumn{1}{c}{} &
\multicolumn{1}{c}{nonadiabatic} &
...
\begin{table}[h]
\setlength{\extrarowheight}{1pt}
\caption{Nonadiabatic corrections for the ground-state energies of atoms and ions. The DBOC contribution is also listed. All energies are reported in units of mHa.\label{tab:nad-ad-atoms}}
\begin{tabular}{cccc}
\hline\hline
System & $E_n-E_c$&  DBOC     &   Remaining \\ \hline
Li$^+$ &  0.58(4) &  0.591970 &   -0.016970 \\
Li     &  0.64(2) &  0.608411 &    0.031889 \\
Be$^+$ &  0.88(2) &  0.899706 &   -0.015706 \\
Be     &  0.88(3) &  0.920848 &   -0.042848 \\
B$^+$  &  1.33(4) &  1.242988 &    0.091012 \\
B      &  1.34(4) &  1.241669 &    0.099331 \\
C$^+$  &  1.72(6) &  1.710382 &    0.009618 \\
C      &  1.75(5) &  1.710900 &    0.039100 \\
N$^+$  &  2.06(6) &  2.066914 &   -0.002914 \\
N      &  2.10(8) &  2.069149 &    0.029851 \\
O$^+$  &  2.6(1)  &  2.440320 &    0.173680 \\
O      &  2.7(2)  &  2.441821 &    0.208179 \\
F$^+$  &  2.4(1)  &  2.675128 &   -0.276128 \\
F      &  2.5(1)  &  2.678181 &   -0.203181 \\
\hline\hline
\end{tabular}
\end{table}
...
\begin{table}[h]
\setlength{\extrarowheight}{1pt}
\caption{Nonadiabatic corrections for the ground-state energies of diatomics.The ZPE and DBOC contributions are also listed. All energies are reported in units of mHa.\label{tab:nad-ad-diatomics}}
\begin{tabular}{ccccc}
\hline\hline
System & $E_n-E_c$ &   ZPE &      DBOC &  Eremaining \\ \hline
LiH  &   4.28(3)   &  3.17 &  0.902410 &    0.202690 \\
BeH  &   6.00(6)   &  4.65 &  1.251000 &    0.090500 \\
BH   &   7.65(8)   &  5.34 &  1.692559 &    0.615441 \\
CH   &   10.8(3)   &  6.44 &  2.109487 &    2.287513 \\
OH   &   11.1(5)   &  8.43 &  2.670397 &    0.019602 \\
HF   &   12.0(4)   &  9.34 &  2.799624 &   -0.124624 \\
\hline\hline
\end{tabular}
\end{table}
