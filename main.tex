...
\item[d] The atomization energy for BeH in Ref.~\cite{CCCBDB} disagrees with previous high-level theoretical benchmarks,~\cite{Feller_Corrections,Bubin_BeH_noBO} thus we use Ref.~\cite{HH} instead. \textcolor{red}{Additionally we note that other experimental results for LiH might be more accurate.~\cite{HH}} 
\end{tablenotes}
\end{threeparttable}
\end{table*}
