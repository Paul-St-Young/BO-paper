...
\begin{tabular}{*{1}{*{7}{c}}}
\hline\hline
$\text{Molecule}$ & $\text{LiH}$ & $\text{BeH}$ & $\text{BH}$ & $\text{CH}$ & $\text{OH}$ & $\text{HF}$ \\ \hline
$\text{Guess}$ & $\text{CAS(4,43)}$ & $\text{CAS(5,44)}$ & $\text{CAS(4,14)}$ & $\text{CAS(7,20)}$ & $\text{CAS(5,20)}$ & $\text{CAS(6,20)}$ \\
$\text{FN-DMCe}$ & $\text{-8.070521(7)}$ & $\text{-15.24793(1)}$ & $\text{-25.28868(2)}$ & $\text{-38.4781(1)}$ & $\text{-75.7352(1)}$ & $\text{-100.44941(6)}$ \\
$E_{\text{Ref}}$ & $-8.07045$ & $-15.247846$ & $-25.287650$ & $\text{-38.478048(DFT)}$ & $-75.720$ & $-100.442$ \\
$\text{FN-DMCei}$ & $\text{-8.06620(2)}$ & $\text{-15.24196(7)}$ & $\text{-25.28103(4)}$ & $\text{-38.4725(1)}$ & $\text{-75.7260(4)}$ & $\text{-100.4391(4)}$ \\
...
$E^{\text{at}}_{ei}$ & 0.08905(2)  & 0.0758(7)  & 0.12886(5) & 0.13000(6) & 0.16317(4) & 0.21037(5) \\
