...
We find the ionization energies of the atoms to be independent of the 
Born-Oppenheimer approximation. The atomization energies of molecular systems, however, are 
influenced by the non-adiabatic coupling between electrons and nuclei at 
the sub mHa level. We demonstrate that the fixed-node approximation provides 
...
%A survey of the amount of non-adiabatic contribution to the ground-state energies revealed that the DBOC is the dominant contribution for all systems studied, with BH and CH being the only exceptions.
