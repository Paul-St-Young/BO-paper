...
$\text{FN-DMCei}$ & $\text{0}$ & $\text{-14.32386(2)}$ & $\text{-24.34750(3)}$ & $\text{-37.42904(4)}$ & $\text{-54.05182(9)}$ & $\text{-74.56336(8)}$ & $\text{0}$ \\
\hline
...
$E_{\text{Ref}}$ & $\text{-8.07045}$ & $0$ & $\text{-15.247846}$ & $\text{-25.287650}$ \\
